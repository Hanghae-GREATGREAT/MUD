...
class Characters extends Model<InferAttributes<Characters>, InferCreationAttributes<Characters>> {
    ...
    declare addExp: (characterId: number, exp: number) => Promise<UserCache | null>;
