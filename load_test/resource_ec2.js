const LOCAL_URL = 'http://localhost:3333/api/resource';
const EC2_URL = 'http://3.35.173.214:3333/api/resource';
/**
 * 
 ...
 * 
 */
module.exports = getResourceUsage = async(URL) => {
    ...
    return { OS_LOADAVGH, totalMemory, availableMemory, userCpuSeconds, cpuConsumptionPercent };
}

// getResourceUsage(EC2_URL);
// (async() => {
//     const { OS_LOADAVGH, totalMemory, availableMemory, userCpuSeconds, cpuConsumptionPercent } = await getResourceUsage(`${SERVER_URL}`);
//     const [ONE_MIN, FIVE_MIN, FIFTEEN_MIN] = OS_LOADAVGH;
//     const totalMemoryMb = (totalMemory/1024/1024).toFixed(2);
//     const availableMemoryMb = (availableMemory/1024/1024).toFixed(2);
//     console.log(`
