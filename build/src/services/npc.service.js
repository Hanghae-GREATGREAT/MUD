...
class NpcService {
    ...
    healing(characterId) {
        return __awaiter(this, void 0, void 0, function* () {
            const Character = yield models_1.Characters.findByPk(characterId);
            if (!Character) {
    ...
    gamble(characterId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let tempScript = '다섯 번의 주사위 게임을 통해 랜덤한 성장 효과를 받을 수 있습니다.\n\n';
            let victoryPoint = 0;
            console.time('겜블');
            for (let i = 0; i < 5; i++) {
